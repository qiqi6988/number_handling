...
** Date: <June 21, 2011>
**
** Edited and revised by lmonk, November, 2011
**  C Number handling weakness class, CWE 190
**  mistake in code is choice of type for variable lines_of_code
**  this easily allows negative values, which trigger
**  a fairly bogus infinite loop, resulting in a resource consumption DOS
**
** Derived from Base Test Program -- TC_C_190_base
**
...
**	lines are encountered, then the counts will be incorrect.  Also a "slash asterisk" sequence that
**	appears within an escaped string will lead to incorrect
...
**
** This is one of the base test programs for CWE 190, specifically used for the source taint file contents
** It alters the countlines.c program by creating an easily overflowed counter for number of lines.
** This is achieved by changing the line counter variable from an integer
** to a char. The char is thus easily overflowed by inputting more than 127 lines of code.
**
** STONESOUP Weakness Class: C Number Handling
** 	 CWE ID: CWE-190
**   Variant Spreadsheet Rev #: 2
**   Variant Spreadsheet ID: 295
**
** Variant Features:
...
int main (int argc, char *argv[])
{
	...
	char lines_of_code; //numeric_type_allows_overflow
	...
	filename[x*y] = '\0';	//STONESOUP:DATA_FLOW:ARRAY_INDEX_NONLINEAR_EXPRESSION
